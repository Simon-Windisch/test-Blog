 ...
 * @seit 2.6.0
 */
define('AUTH_KEY',         'pdrhtglkaudzrtukzergkjahfdbköji');
define('SECURE_AUTH_KEY',  'skl6z7livreszgkjwruklsudölhjk');
define('LOGGED_IN_KEY',    'eruer6urtfrufuzzffuurturzt');
define('NONCE_KEY',        'trurh5urtjrtibr69579hir76');
define('AUTH_SALT',        't86hh8ir76ujrtzir7ih6rk8zrj');
define('SECURE_AUTH_SALT', 'rhi5hit7iftbit6j95jihr67uir6');
define('LOGGED_IN_SALT',   'oei7thwielztwuzöuirtpoztzz');
define('NONCE_SALT',       'lgzhoizujilruzirtuzoeruize');
...
/* Anpassungen gemaess Ticket https://mxd.inovex.de/issues/4232 */
